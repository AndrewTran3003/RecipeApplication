...
public class ReorderServiceTest {
    ...
    public void TestReorderRecipes(){
        ...
        recipeList.add(selectRecipesTestData.getCheeseToastie());
        ...
        Assertions.assertEquals(6, reorderedRecipeList.getRecipes().size());
        ...
        Assertions.assertEquals("cheesetoastie",reorderedRecipeList.getRecipes().get(4).getName());
        Assertions.assertEquals("butteregg",reorderedRecipeList.getRecipes().get(5).getName());
